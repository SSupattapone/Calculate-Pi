...
π = 1.0/sum([((-1.0)**k)/math.factorial(k) for k in range(0,n)])
print("The approximate value of π is {0:.{1}f}".format(π, decimals))
print("(The true value of π is {0:.{1}f})".format(math.π, decimals))